...
//			}
	...
	.text(function(d, i) {
		return "(" + format1(dvc.essential.actual2015[i]) + " babies) " + dvc.essential.legendLabels[i];
	})
	.attr('y', function(d,i) {
...
//		} else {
	...
	.attr('text-anchor','start');
									...
									linegroups.append('text')
										...
										.text(function(d, i) {
											return dvc.essential.legendLabels[i] + " (" + format1(dvc.essential.actual2005[i]) + " babies)";
										})
										.attr('y', function(d) {
